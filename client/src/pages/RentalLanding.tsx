...
const equipmentCategories = [
  {
    ...
    image: "/manus-storage/bob-mobile-crane-lift_afef880a.jpg",
    tone: "dark",
  },
  {
    ...
    image: "/manus-storage/bob-crawler-crane-lift_5a59d9e2.jpg",
    tone: "light",
  },
  {
    ...
    image: "/manus-storage/bob-crawler-crane-site_ff708e47.jpg",
    tone: "dark",
  },
] as const;
  ...
  return (
    <main className="rental-landing">
      ...
      <section className="rental-band">
        <img src="/manus-storage/bob-crawler-crane-site_ff708e47.jpg" alt="Crane equipment prepared on an industrial project site" loading="lazy" />
      ...
      <section className="rental-section rental-process" id="how-it-works">
        <div className="rental-container">
          <div className="rental-process-feature">
            <img src="/manus-storage/bob-crawler-crane-lift_5a59d9e2.jpg" alt="Crawler crane performing an industrial lift" loading="lazy" />
