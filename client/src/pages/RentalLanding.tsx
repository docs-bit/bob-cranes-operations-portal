  ...
  return <main className="bob-rental" id="top">
    <header className="bob-nav-shell">
      <div className="bob-nav">
        <button className="bob-brand bob-brand-full" onClick={() => scrollToId("top")} aria-label="Back to BOB Heavy Equipment Rental home"><img src="/manus-storage/bob-lifting-your-expectations_2beae224.webp" alt="BOB Cranes — Lifting Your Expectations" /></button>
