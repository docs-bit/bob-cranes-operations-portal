...
const BOB_MOBILE = "/assets/cranes/site-lift.jpeg";
const BOB_BRIDGE = "/assets/cranes/bob-branded-crane.jpeg";
const BOB_FLEET = "/assets/cranes/fleet-yard.jpeg";
const BOB_FRONT = "/assets/cranes/crane-front.jpeg";
const BOB_RENTAL = "/assets/cranes/crane-rental.jpg";
...
const projectCards = [
  [BOB_MOBILE, "Site lift support", "Equipment rental", "A practical starting point for equipment-led lift planning."],
  [BOB_BRIDGE, "BOB branded fleet", "Controlled handoff", "Recognisable equipment, crew and documentation aligned around the lift."],
  [BOB_FLEET, "Managed mobilisation", "Operations route", "A connected route from the first brief to dispatch readiness."],
] as const;
