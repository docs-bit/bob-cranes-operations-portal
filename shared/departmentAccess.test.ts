...
import { canAccessDepartment, canManageDepartmentUsers, canAccessWorkspaceView, roleLabel } from "./departmentAccess";
...
describe("department supervisor access", () => {
  ...
  it("lets administrators manage every department and keeps supervisor portals visible", () => {
